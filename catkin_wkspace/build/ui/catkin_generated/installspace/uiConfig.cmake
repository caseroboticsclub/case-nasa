...
if("FALSE" STREQUAL "TRUE")
  set(ui_SOURCE_PREFIX /home/saruman/workspaces/ros_workspace/case_robotics/nasa/catkin_wkspace/src/ui)
  set(ui_DEVEL_PREFIX /home/saruman/workspaces/ros_workspace/case_robotics/nasa/catkin_wkspace/devel)
  set(ui_INSTALL_PREFIX "")
  set(ui_PREFIX ${ui_DEVEL_PREFIX})
else()
  set(ui_SOURCE_PREFIX "")
  set(ui_DEVEL_PREFIX "")
  set(ui_INSTALL_PREFIX /home/saruman/workspaces/ros_workspace/case_robotics/nasa/catkin_wkspace/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir}" STREQUAL "include")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'ui' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'saruman <saruman@todo.todo>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'ui' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/saruman/workspaces/ros_workspace/case_robotics/nasa/catkin_wkspace/install/${idir}'.  Ask the maintainer 'saruman <saruman@todo.todo>' to fix it.")
    endif()
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${ui_dep}_FOUND)
      find_package(${ui_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${ui_dep} REQUIRED ${depend_list})
  endif()
  ...
  list(APPEND ui_EXPORTED_TARGETS ${${ui_dep}_EXPORTED_TARGETS})
endforeach()
