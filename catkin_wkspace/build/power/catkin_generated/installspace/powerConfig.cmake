...
if("FALSE" STREQUAL "TRUE")
  set(power_SOURCE_PREFIX /home/saruman/workspaces/ros_workspace/case_robotics/nasa/catkin_wkspace/src/power)
  set(power_DEVEL_PREFIX /home/saruman/workspaces/ros_workspace/case_robotics/nasa/catkin_wkspace/devel)
  set(power_INSTALL_PREFIX "")
  set(power_PREFIX ${power_DEVEL_PREFIX})
else()
  set(power_SOURCE_PREFIX "")
  set(power_DEVEL_PREFIX "")
  set(power_INSTALL_PREFIX /home/saruman/workspaces/ros_workspace/case_robotics/nasa/catkin_wkspace/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir}" STREQUAL "include")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'power' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'saruman <saruman@todo.todo>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'power' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/saruman/workspaces/ros_workspace/case_robotics/nasa/catkin_wkspace/install/${idir}'.  Ask the maintainer 'saruman <saruman@todo.todo>' to fix it.")
    endif()
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${power_dep}_FOUND)
      find_package(${power_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${power_dep} REQUIRED ${depend_list})
  endif()
