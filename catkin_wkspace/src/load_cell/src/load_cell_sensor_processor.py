...
## file: load_cell_sensor_processor.py
##
## package: load_cell
##
...
to_publish = "load_cell_sensor_listener"

def on_receive_load_cell_sensor_data_topic(data):
    to_publish = data

def load_cell_sensor_processor():
    rospy.init_node('load_cell_sensor_processor', anonymous=False)
...
if __name__ == '__main__':
    try: load_cell_sensor_processor()
